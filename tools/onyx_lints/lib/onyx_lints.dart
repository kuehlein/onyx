...
import 'src/no_card_type_branch.dart';

/// Entry point discovered by the `custom_lint` runner. Registers Onyx's
/// design-token + architecture-invariant rules; they run alongside riverpod_lint's
/// (the runner aggregates every dependency that exposes a `createPlugin`).
