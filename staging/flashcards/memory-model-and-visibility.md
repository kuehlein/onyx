...
- **[Sequential consistency](_meta/glossary.md#sequential-consistency) (SC)** = all threads observe **one single global total order** of operations consistent with each thread's program order. It is the intuitive model but is *not* what hardware/compilers give you by default — you get it only by using enough synchronization.
