...
- **Blockchain** — one example: a block header commits to its transactions via a Merkle root, enabling light-client / **SPV** inclusion proofs without downloading full blocks over the [P2P](_meta/glossary.md#p2p) network.
